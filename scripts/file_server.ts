...
import { posix, extname } from "https://deno.land/std@0.57.0/path/mod.ts";
...
import { assert } from "https://deno.land/std@0.57.0/_util/assert.ts";
...
function main(): void {
  ...
  listenAndServe(
    ...
    async (req): Promise<void> => {
      ...
      let normalizedUrl = posix.normalize(pureUrl);
      try {
